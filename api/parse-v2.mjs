...
const schema = {
  ...
  required: ["kind","meal","title","author","kcal","kcalExplicit","p","c","f","estimated","type","minutes","distance","elevation","intensity","sys","dia","pulse","context","weight","smokingAction"],
  properties: {
